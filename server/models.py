...
class User(db.Model, SerializerMixin):
    ...
    serialize_rules = ('-projects.user', '-interests.user')

class Project(db.Model, SerializerMixin):
    __tablename__ = 'projects'
    serialize_rules = ('-user.projects', '-comments.project', '-interests.project')
...
class UserInterest(db.Model, SerializerMixin):
    ...
    serialize_rules = ('-user.interests', '-interest.user_interests')
...
class ProjectInterest(db.Model, SerializerMixin):
    ...
    serialize_rules = ('-project.interests', '-interest.project_interests')
...
class Comment(db.Model, SerializerMixin):
    ...
    serialize_rules = ('-project.comments', '-user.comments')
